...
/**
 * Sert a lire et parser les fichiers
 */
public class LecteurGedcom {
    ...
    /**
     * Récupère les dictionnaires de Genealogie (base de donnée)
     */
	...
	/**
	 * Cette fonction gère un fichier GEDCOM a la fois
	 * créer les relations qui y correspondent
	 * et tous les tags suivants ;
	 * niveau 0 : HEAD, TRLR, INDI, FAM
	 * niveau 1 :  NAME, SEX, FAMC, FAMS, HUSB, WIFE, CHIL
	 */
            ...
            while ((ligne = br.readLine()) != null) {	
                ...
                if (niveau == 0) {
                    ...
                    switch (tag) {
	                    ...
	                    default:
	                        System.out.println("ce tag est inconnu : " + tag);
                }
            }
                else if (niveau == 1) {
