...
/**
 * Cette classe permet de gérer un individu
 * L'individu a un Nom, un sexe, un id, la famille dont il est enfant 
 * et tous ses familles où il est parent
 */
...
public class Individu implements Serializable{
	...
	/**
     * Renvoie tous les enfants de la famille
     */
	...
	/**
     * Renvoie tous les freres et Soeurs de la famille
     */
	...
	/**
	 * Cherche dans Toutes les familles où elle est parente si elle est marié
     * Renvoie True si la personne est marié avec cette personne
     */
    ...
    // Modification pour nettoyer les /
    public void setNom(String valeurNom) {
        if (valeurNom != null) {
            String propre = valeurNom.replace("/", ""); 
            this.nom = new TagNom(propre);
        } else {
            this.nom = new TagNom("Inconnu");
        }
    }
	...
	public TagSexe getTagSexe() { return sexe; }
